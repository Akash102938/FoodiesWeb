...
function About() {
    ...
    overflow-hidden relative'>
            ...
            <motion.section initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }}
                ...
                bg-gradient-to-r from-amber-500 to-yellow-600'>
                    ...
                    <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                        Crafting unforgettable dining expirences delivered to your doorstep.
                    </motion.p>
                </div>
            ...
            <section className='py-16 px-4 md:px-8 bg-gradient-to-br from-[#1a120b] to-[#3c2a21]/90'>
                <div className='max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8'>
                    {stats.map((s, i) => {
                     ...
                     rounded-xl border-amber-600/30 p-6 overflow-hidden transition-all duration-300'>
                         ...
                         shadow-amber-900/20'/>
                            ...
                            from-amber-200 to-amber-400 text-transparent'>
                                            ...
                                            <motion.div className='text-sm tracking-widest font-medium
                            text-amber-100/80'
                                                animate={{
            ...
            <section className='px-16 px-4 md:px-8 relative'>
