    ...
    <footer className='bg-[#2A211C] text-amber-100 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden'>
      <div className='max-w-7xl mx-auto relative z-10 '>
            ...
            <form onSubmit={handleSubmit} className='relative mt-4 group'>
              ...
              <div className='relative'>
                ...
                <button type='submit' className='absolute right-1 top-1 bg-gradient-to-br from-amber-300
                  ...
                  <span className='font-bold text-sm tracking-wide transition-transform duration-300 group-hover:-tranlate-x-1'>
                    Join Now
                  </span>
                  <BiChevronRight className='text-xl transition-transform duration-300 group-hover:animate-spin
                        flex-shrink-0' />
                  <span className='absolute inset-0 -translate-x-full g-gradient-to-r from-transparent
             ...
             <div className='space-y-4'>
                ...
                <div className='flex space-x-4'>
                   {socialIcons.map(({icon: Icon, link, color,label},idx)=>(
                    ...
                    className='text-2xl bg-amber-400/10 p-3 rounded-full  hover:bg-amber-400/40 hover:scale-110
        ...
        <div className='border-t border-amber-800 pt-8 mt-8 text-center'>
           <p className='text-amber-400 text-lg mb-2 font-playfiar'>
            &copy; 2025 Foodie-Frenzy All roght reserved
           </p>
           <div className='group inline-block'>
               <a href="https://github.com/Akash102938/FoodiesWeb"
               ...
               to-amber-400 bg-clip-text text-transparent hover:text-purple-300 transition-all duration-500'>
                Code Written By Akash Pandey Published on Github 
               </a>
           </div>
        </div>
      </div>
