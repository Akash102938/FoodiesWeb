...
function CartPage() {
  ...
  // Build Image URL (Handles both local + external)
  ...
  return (
    <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d]">
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {cartItems.map((ci) => {
                ...
                return (
                  <div
                    key={_id}
                    className="group bg-amber-900/20 p-4 rounded-xl border-4 border-dashed border-amber-500 backdrop-blur-sm flex flex-col items-center gap-4 transition-all duration-300 hover:border-solid hover:shadow-xl hover:shadow-amber-900/10 transform hover:-translate-y-1 animate-fade-in"
                  >
                    {/* Image */}
                    <div
                      className="w-24 h-24 flex-shrink-0 cursor-pointer overflow-hidden rounded-lg"
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="w-8 h-8 rounded-full bg-amber-900/40 flex items-center justify-center active:scale-95"
                      >
                    ...
                    <div className="flex items-center justify-between w-full">
                      <button
                        ...
                        className="bg-amber-900/40 px-3 py-1 rounded-full text-xs uppercase flex items-center gap-1 hover:bg-amber-800/50 active:scale-95"
                      >
            ...
            <div className="mt-12 pt-8 border-t border-amber-800/30 animate-fade-in-up">
              <div className="flex flex-col sm:flex-row justify-between items-center gap-8">
                ...
                <Link
                  to="/menu"
                  className="bg-amber-900/40 px-8 py-3 rounded-full font-cinzel uppercase hover:bg-amber-800/50 active:scale-95"
                >
                  Continue Shopping
                </Link>
                ...
                <div className="flex items-center gap-8">
                  ...
                  <Link to='/checkout' className="bg-amber-900/40 px-8 py-3 rounded-full font-cinzel uppercase tracking-wider hover:bg-amber-800/50 active:scale-95 text-amber-100">
                    Checkout Now
                  </Link>
                </div>
      ...
      {selectedImage && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-amber-900/40 backdrop-blur-xl p-4"
        ...
        >
          <div className="relative max-w-full max-h-full">
            ...
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-1 right-1 bg-amber-900/80 rounded-full p-2 text-black hover:bg-amber-800 active:scale-95"
            >
