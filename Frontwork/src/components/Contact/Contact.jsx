...
function Contact() {
    ...
    const handleSubmit = (e)=>{
        ...
        //WHATSAPP NO
        const whastsappNumber = '+91 7050035843'

        //WHATSAPP API
        const whatsappUrl = `https://api.whatsapp.com/send?.phone=${whastsappNumber}&text=${encodedMessage}`;

        toast.success('OPENING WHATSAPP...',{
            style:{
                border: '2px solid #f50e0b', padding: '16px', color: '#fff',
  ...
  return (
    <div className='min-h-screen bg-gradient-to-r from-orange-900 via-amber-900 to-gray-900 animate-gradient-x p-12
        ...
        <div className='max-w-7xl mx-auto relative z-10'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            ...
            <div className='space-y-6'>
               <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl p-6 shadow-2xl transform transition-all
               duration-300 hover:scale-[1.02] animate-card-float border-1-4 border-amber-500 hover:border-amber-400 group'> 
                 ...
                 <div className='pl-12 relative z-10'>
                    <p className='text-amber-100 font-light z-10'>
                        Lucknow, UP
                    </p>
                 </div>
               </div>
               ...
               <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl p-6 shadow-2xl transform transition-all
               duration-300 hover:scale-[1.02] animate-card-float border-1-4 border-green-500 hover:border-green-400'> 
                 <div className='absolute inset-0 bg-gradient-to-r from-green-500/10 to-transparent opacity-0
                 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl'/>

                 <div className='flex items-center mb-4 relative z-10'>
                     <div className='p-3 bg-gradient-to-br from-green-500/30 to-transparent to-green-700/30 rounded-xl'>
                ...
                <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl p-6 shadow-2xl transform transition-all
               duration-300 hover:scale-[1.02] animate-card-float border-1-4 border-orange-500 hover:border-orange-400'> 
                 ...
                 <div className='flex items-center mb-4 relative z-10'>
                     ...
                     <h3 className='ml-4 text-orange-100 text-xl font-semibold'>Our Headquater</h3>
                 </div>

                 <div className='pl-12 relative z-10'>
                    <p className='text-amber-100 font-light z-10'>
                        froodyfreenzy123@gmail.com
                    </p>
                 </div>
               </div>
            </div>
          ...
          {/*CONTACT FORM */}
           ...
           <form onSubmit={handleSubmit} className='space-y-6 relative z-10'>
            {contactFormFields.map(({label,name,type,placeholder,pattern, Icon})=>(
                <div key={name}>
                  ...
                  <div className='relative'>
                    ...
                    className='w-full pl-10 pr-4 py-3  bg-white/10 border-amber-500/30 rounded-xl
            ...
            <button type='submit' className='w-full bg-gradient-to-r from-amber-600 to-orange-500 hover:from-amber-700
