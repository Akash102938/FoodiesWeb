      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:gap-8 xl:gap-16 relative'>
        <div className='w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative'>
          <div className='space-y-4 sm:space-y-8 px-4 sm:px-0'>
            ...
            <p className='text-base sm:text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl font-serif italic border-l-4 border-amber-500/60 pl-4 sm:pl-6 py-2 bg-linear-to-r from-white/5 to-transparent'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 px-4 sm:px-0'>
             {aboutfeature.map((item,i)=>(
              <div key={i} className='flex flex-col items-center justify-center gap-4 sm:gap-4 transition-transform
              duration-300 p-4 sm:p-5 hover:translate-x-2'>
                  <div className={`p-3 sm:p-4 rounded-full bg-linear-to-br ${item.color}
          ...
          <div className='flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0'>
             ...
             >
               <span className="absolute inset-0 bg-linear-to-r from-amber-600/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
               <FaInfoCircle className="text-lg sm:text-xl animate-pulse" />
               <span className="font-cursive text-lg sm:text-xl">Unveil Our Story</span>
             </Link>
          </div>
        </div>
        <div className='w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12vmb-10 lg:mb-0 relative
        group transform hover:scale-[1.01] transition-all duration-500'>
            ...
            duration-500 shadow-2xl shadow-black/50'>
              <div className='absolute inset-0 bg-linear-to-br from-amber-400/15 via-transparent to-amber-600/10 mix-blend-lighten'/>
                <img src={AboutImage} alt="Restaurant" className='w-full h-auto object-cover apsect-[3/4] transform
                -rotate-1 hover:rotate-0 transition-all duration-500' />

                <div className='absolute -bottom-12 left-1/2 -translate-x-1/2 w-4/5 h-15 bg-amber-900/30 blur-3xl
                z-0'/>
            </div>
