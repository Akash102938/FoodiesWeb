...
function SpecialOffer() {
  ...
  useEffect(() => {
    axios
      .get('https://foodiesweb-1.onrender.com/api/items')
    ...
    <div className="bg-gradient-to-b from-[#1a1212] to-[#2a1e1e] text-white py-16 px-4 font-[poppons]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto tracking-wider">
        ...
        <div className="grid grid-cols-1 sm:grid-cols md:grid-cols-3 lg:grid-cols-4 gap-8">
          {displayList.map(item => {
            ...
            return (
              <div key={item._id} className="relative group bg-[#4b3b1b] rounded-3xl overflow-hidden shadow-2xl 
                transform hover:-translate-y-4 transition-all duration-500 hover:shadow-red-900/40 
                border-2 border-transparent hover:border-amber-500/20 before:absolute before:inset-0 
              ...
              >
                ...
                <div className="relative h-72 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center
                    bg-black/40 backdrop-blur-sm px-4 rounded-full"
                  >
                ...
                <div className="p-6 relative z-10">
                  <h3 className="text-2xl font-bold mb-2 bg-gradient-to-r from-amber-400 to-amber-500 bg-clip-text text-transparent italic font-[Playfair_Display]">
                    {item.name}
                  </h3>
                    ...
                    {qty > 0 ? (
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className="w-8 h-8 rounded-full bg-amber-900/40 flex items-center justify-center hover:bg-amber-800/50 transition"
                        >
                      ...
                      >
                        <div className="absolute inset-0 bg-graadient-to-r from-amber-500/20 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300" />
        ...
        <div className="mt-12 flex justify-center">
          <button
            ...
            className="flex items-center gap-3 bg-gradient-to-r from-red-700 to-amber-700 text-white 
            px-8 py-4 rounded-2xl font-bold text-lg uppercase tracking-wider hover:scale-105 transition-all"
          >
