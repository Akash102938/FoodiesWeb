      ...
      <div className='bg-gradient-to-br from-amber-900 via-amber-800 to-amber-700 text-white
        ...
        <div className='max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10'>
          ...
          <div className='flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left '>
            ...
            <p className='text-lg md:text-lg lg:tect-xl font-playfair italic sm:text-xl text-amber-100
                  max-w-xl opacity-90 mx-auto md:mx-0'>
              Best cooks and best delivery gudy all at your service. Hot tasty food will reach you in 60 minutes.
            </p>
            <form onSubmit={handleSearch} className='relative max-w-2xl mx-auto md:mx-0 group'>
              <div className='relative flex items-center bg-amber-900/30 rounded-xl border-2 border-amber-500
                ...
                <button className='mr-4 px-6 py-3 bg-gradient-to-r from-amber-400 to-amber-300
            ...
            <div className='flex flex-wrap gap-4 justify-center md:justify-start mt-6'>
              <button className='group flex items-center gap-3 bg-amber-800/30 hover:bg-amber-800/30 px-6
